...
const Vue = () => {
  ...
  useEffect(() => {
    fetch('/Framework/Vue.json') // Assuming the JSON data is stored in /public/Framework/Vue.json
    ...
    <>
      ...
      <div className="w-full bg-gradient-to-r from-purple-100 via-purple-200 to-purple-300 text-gray-800">
        <div className="p-6 max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-6 text-teal-400">Vue.js Concepts</h1>
