          ...
          <div className="space-y-6">
            {Object.keys(data).map((key) => (
              ...
              >
                ...
                {data[key].hooks && (
                  <div className="mt-4">
                    <h3 className="font-medium text-teal-400 mb-2">Hooks:</h3>
                    <ul className="list-disc pl-5 text-gray-300 space-y-2">
                      {Object.keys(data[key].hooks).map((hookKey) => (
                        <li key={hookKey} className="flex flex-col space-y-1">
                          <strong className="text-gray-200">{hookKey}:</strong> 
                          <code className="bg-gray-700 p-1 rounded text-gray-100">
                            {data[key].hooks[hookKey]}
                          </code>
                        </li>
                      ))}
                    </ul>
